...
//
//                Song song1 = new Song("Formation", Duration.ofMinutes(3).plusSeconds(26), album1.getId(),
//                        artist1.getId());
//                Song song2 = new Song("Shape of You", Duration.ofMinutes(3).plusSeconds(53), album2.getId(),
//                        artist2.getId());
//                Song song3 = new Song("HUMBLE.", Duration.ofMinutes(2).plusSeconds(57), album3.getId(),
//                        artist3.getId());
